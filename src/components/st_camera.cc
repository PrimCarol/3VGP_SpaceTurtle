...
void ST::CameraComponent::setTarget(glm::vec3 target) {
	target_ = target;
}

//void ST::CameraComponent::fpsMovement(ST::Window& w, float MoveSpeed, float RotateSpeed) {
...
//void ST::CameraComponent::update() {
